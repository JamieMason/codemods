export default (file, api) => {
  ...
  const isAssigningPropTypes = (e) => e.node.left.property.name === 'propTypes';
  const isImportingFromPropTypes = (e) => e.node.source.value === 'prop-types';
  const isRequiringFromPropTypes = (e) =>
    e.node.init.callee && e.node.init.callee.name === 'require' && e.node.init.arguments[0].value === 'prop-types';
